# The sub-pipeline works on the Irish Shotgun Cohorts (ISC) data repository and performs the following tasks:
...
# The sub-pipeline requires the workspace isc_stage1_results.RData which is the output of the previous two sub-pipelines run_isc_analysis_stage1a.R, followed by
# run_isc_analysis_stage1b.R, along with the isc_analysis_2021_Revision.RData which is the running workspace of the ISC dataset analysis (after the execution
# of run_isc_analysis_stage1a.R and run_isc_analysis_stage1b.R)
