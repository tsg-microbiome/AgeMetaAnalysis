# The sub-pipeline works on the NUAGE data repository and performs the following tasks:
...
# The sub-pipeline requires the workspace nuage_stage1_results.RData which is the output of the previous two sub-pipelines run_nuage_analysis_stage1a.R, followed by
# run_nuage_analysis_stage1b.R, along with the nuage_analysis_2021_Revision.RData which is the running workspace of the NUAGE dataset analysis (after the execution
# of run_nuage_analysis_stage1a.R and run_nuage_analysis_stage1b.R)
